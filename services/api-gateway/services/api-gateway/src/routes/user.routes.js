  ...
  try {
    ...
    const [notifs, total, unreadCount] = await Promise.all([
      prisma.notification.findMany({
        ...
        skip,
        take:    limit,
        select:  { id: true, type: true, messageEn: true, messageSw: true, status: true, createdAt: true, transactionId: true, transferId: true, houseEscrowId: true, orderId: true, requestId: true, deliveryOrderId: true, customEscrowId: true, fundiJobId: true, diasporaDealId: true }
      }),
