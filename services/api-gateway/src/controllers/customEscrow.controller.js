...
const createCustomEscrow = async (req, res) => {
  try {
    ...
    const { createAndSend: _cn1 } = require('../services/notificationService')
...
const acceptDeal = async (req, res) => {
  try {
    ...
    const { createAndSend: _cn2 } = require('../services/notificationService')
...
const rejectDeal = async (req, res) => {
  try {
    ...
    const { createAndSend: _cn3 } = require('../services/notificationService')
...
const buyerConfirmDeal = async (req, res) => {
  try {
    ...
    const { createAndSend: _cn4 } = require('../services/notificationService')
...
const counterpartyConfirmDeal = async (req, res) => {
  try {
    ...
    const { createAndSend: _cn5 } = require('../services/notificationService')
