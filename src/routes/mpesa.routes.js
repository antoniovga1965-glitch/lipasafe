...
router.post('/callback',                safaricomOnly, callback)
...
router.post('/b2c/result',   safaricomOnly, b2cCtrl.b2cResult)
router.post('/b2c/timeout',  safaricomOnly, b2cCtrl.b2cTimeout)
router.post('/b2b/result',   safaricomOnly, b2bCtrl.b2bResult)
router.post('/b2b/timeout',  safaricomOnly, b2bCtrl.b2bTimeout)
