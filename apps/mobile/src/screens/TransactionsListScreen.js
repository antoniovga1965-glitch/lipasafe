...
export default function TransactionsListScreen({ navigation }) {
  ...
  const allData = useMemo(() => [
    ...
    ...txs,
  ], [bundleTxs, deliveryOrders, secondHandTxs, fundiJobs, houseEscrows, customEscrows, txs])
...
return (
  ...
  const TYPE_TABS = ['all','bundle','delivery','fundi','second-hand','house','custom','wallet']
